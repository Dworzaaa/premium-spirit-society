...
public class expresscheckout extends HttpServlet {
    ...
    @RequestMapping(value = "/expresscheckout", method = RequestMethod.POST)
    public void doGet(HttpServletRequest request,
        ...
        if (strAck != null && strAck.equalsIgnoreCase("Success")) {
            ...
            response.sendRedirect(response.encodeRedirectURL("https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=" + nvp.get("TOKEN").toString()));
